...
- 能够将多个低严重性漏洞串联成具有可运行概念验证（PoC）的高危漏洞利用
- 此前的前沿模型最多止步于"有趣的漏洞，但尚不清楚是否可被利用"，Mythos 跨越了这一门槛
- 在分类排查阶段，产生更少的模棱两可结果，减少"这到底是不是真的？"的追问
...
Anthropic 发现 Mythos 攻防能力过强后，做出了 AI 历史上第一次因"攻防失衡"而主动搁置发布的决定，并启动 [[project-glasswing]] 合作计划。这一决策被比喻为"把魔戒送到末日火山"。
