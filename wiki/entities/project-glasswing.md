...
在硅谷传闻中，[[oceanus-mythos|Oceanus/Mythos]] 的早期预览版在进行内部测试时，展现出可怕的零日漏洞破解能力。一旦泄露，可能对全球互联网基础设施造成灾难性打击。

## 隔离措施

作为 Project Glasswing 的一部分，早期 Mythos 被无限期"囚禁"在隔离网络中，仅允许极少数签署了严苛保密协议的合作伙伴接触。
...
Project Glasswing 揭示了顶级 AI 公司在面对能力远超安全防护水平的模型时所采取的极端隔离措施，也凸显了 [[ai-takeoff|AI 自主进化]] 能力与安全管控之间的深层张力。