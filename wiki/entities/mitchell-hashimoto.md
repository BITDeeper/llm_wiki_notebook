...
### 核心工具创造
Hashimoto 创造了多个在现代 DevOps 和基础设施即代码（IaC）领域具有里程碑意义的工具：

- **[[Vagrant]]**：用于构建和配置虚拟化开发环境的工具。
...
### 早期经历
Hashimoto 与 GitHub 的关系极其深厚。他曾表示，开发 Vagrant 的初衷之一是希望能获得 GitHub 的工作。在过去的 18 年里，GitHub 承载了他几乎所有的开源活动、工作热情甚至个人情感——如在分手后通过开源社区疗伤，蜜月期间提交代码。

### 决裂与出走
2026 年 4–5 月，Hashimoto 发表了一篇充满情感的告别文章（被媒体称为"绝交信"），宣布将 [[Ghostty]] 迁离 GitHub。这一决定的直接原因是 GitHub 持续且频繁的服务宕机，特别是 GitHub Actions 的不稳定。他通过记录日记的方式，证实了过去一个月几乎每天都有宕机发生。
