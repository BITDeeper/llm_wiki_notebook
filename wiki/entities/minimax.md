...
2026年6月M3发布同期，MiniMax调整Token Plan定价引发老用户权益缩水抗议。官方当天发布补偿方案：老用户保留原有权益（对以前没有周限额的老用户保持原有设定），新用户周限额加赠50%。

## 社区反响

M3发布后出现显著的"墙内开花墙外香"现象：国外社区（硅谷CEO站台、开发者深度测试）反响热烈，国内社区则因价格争议和质疑刷榜而吵成一锅粥。