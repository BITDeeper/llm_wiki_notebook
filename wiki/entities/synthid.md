...
type: entity
title: SynthID
tags: [watermarking, ai-safety, copyright, google-deepmind, 水印, ai安全, 内容溯源, google]
related: [google-deepmind, lyria-3, gemini, ai-music-copyright, gemini-omni]
created: 2026-02-19
updated: 2026-05-22
sources: ["谷歌gemini上线ai音乐创作，一夜革了suno的命！.md", "全网实测gemini-omni！一句话改视频，草图变大片.md"]
---
...
- **可验证**：用户上传任何视频到 Gemini App，询问"这是 AI 生成的吗？"，系统会通过水印进行验证
...
在 [[gemini-omni]] 中，SynthID 与 C2PA 跨平台元数据标准共同构成双层强制水印系统。所有 Omni 生成的视频都强制嵌入两层标记：

1. **SynthID**：Google 自家的不可见水印
