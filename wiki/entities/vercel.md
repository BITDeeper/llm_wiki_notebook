...
根据 Amplifying.ai 的研究，Vercel 在 [[Claude Code]] 的工具选择中占据绝对主导地位，已成为 AI 辅助开发模式下的事实标准。

### 数据表现
- **JavaScript 生态首选率**：100%
- **类别**：部署

### 含义
这一数据表明，在涉及 JavaScript/Next.js 项目的部署需求时，[[Claude Code]] 会无一例外地推荐 Vercel，而不考虑其他部署平台（如 Netlify、AWS Amplify 等）。

### 与 Python 生态的对比
值得注意的是，在 Python 生态中，Claude Code 的首选部署平台是 Railway（82% 首选率），而非 Vercel。这显示了 AI 的工具选择高度依赖 [[项目上下文依赖性]]。
...
-   [[Next.js]]：由 Vercel 创始人主导开发的 React 框架。
-   [[护栏]]：Vercel 安全团队建议在 AI Agent 架构中引入的验证层机制。