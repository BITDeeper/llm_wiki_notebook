...
这座新芯片工厂坐落
于
美国德州奥斯汀，目的是实现芯片递归式改进，并探索非传统计算方式；终极目标是让人类文明迈向星际文明，征服星辰大海。
...
Shaun
「
又支持马斯克」，而在于他试图把外界对马斯克的理解，从「政治人物」重新拉回「技术组织者」。
...
NIPS
2012
论文证明，深而大的卷积神经网络，配合GPU和大数据，可以把图像分类效果抬到一个此前难以想象的水平。
这件事的重要性，今天人人都知道。
...
xAI也成了马斯克技术版图里被补上的最后一块关键拼图，补上这块之后，原来相互独立的东西：
X平台、Grok、Tesla视觉栈、Optimus、训练集群、现实世界数据，才开始有了被统一解释的可能。
xAI：算力在手，AI不愁
现在把这个框架套到 xAI。
外界觉得它最近很混乱：
12位创始成员里，过去一年走了超过一半；
