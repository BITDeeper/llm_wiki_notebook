...
就在这个节骨眼上，百度出手了。
2月4日，深度研究智能体权威评测榜单DeepResearch Bench公布最新结果，
百度千帆深度研究Agent
直接登顶榜首
，一举超越OpenAI、Gemini、Claude等一众国际顶尖选手的同类产品。
...
第一和第二
。
DeepResearch Bench是一个专为深度研究智能体设计的综合性基准测试，由学术界和业界共同推动。
它的硬核之处在于
：
...
首先是对问题的分析更加的精细
，相比ChatGPT的深度研究功能，千帆深度研究Agent给出更深入的细节和方向。
...
其次是过程透明。
千帆深度研究Agent允许用户在开始前修改、增删大纲，让用户对研究路径拥有掌控权。
结果交付方面，专业且结构化。
千帆深度研究Agent最终交付不仅仅是文本，更支持生成结构化的精美网页、Markdown文档甚至CSV数据表。
...
百度干了
25年搜索
，这25年积累下来的东西，不是靠短期冲刺能追上的：信源多、覆盖广、中文语义理解深，再加上RAG（检索增强生成）领域的技术积累，这些都是护城河。
