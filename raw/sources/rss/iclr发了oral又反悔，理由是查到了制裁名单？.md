...
给出的理由是
RAIRI 是美国制裁的机构，ICLR 组织在美国注册，必须遵守美国法律，不能接受来自被制裁机构的论文。
...
此次遭拒的论文
提出了一个名为 cadrille 的多模态 CAD 重建模型，能同时处理点云、多视角图像和文本三种输入，最终输出可执行的 Python 代码来生成参数化 CAD 模型。
...
就拿上个月刚发生的
NeurIPS 限制华为等机构
投稿来说，NeurIPS 2026 基金会宣布不接收来自美国制裁机构的论文，还直接链接了 OFAC 制裁名单，在
多位学者拒绝出任 AC
、中国计算机学会（CCF）和中国科协的抵制声明之后，
NeurIPS 终于公开道歉并部分撤销了政策
，承认自己过度合规。
