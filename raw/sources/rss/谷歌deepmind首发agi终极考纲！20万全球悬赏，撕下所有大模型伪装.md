...
这篇名为《Measuring Progress Toward AGI: A Cognitive Framework》的论文，核心主张只有一句话：别再争AGI是什么了，先把
怎么测
这件事搞清楚。
...
5. 记忆（Memory）
存储和检索信息的能力。
包括语义记忆（世界知识）、情景记忆（特定事件）、程序性记忆（技能）、前瞻性记忆（记住未来某个时刻该做的事），以及一个容易被忽视的能力——
遗忘
。
...
与论文同步推出的Kaggle黑客松，精准瞄向评估缺口最大的5种认知能力：
学习、元认知、注意力、执行功能、社会认知
。
