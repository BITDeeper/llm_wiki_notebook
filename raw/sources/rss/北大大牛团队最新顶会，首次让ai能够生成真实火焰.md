...
近日，北京大学智能学院陈宝权教授团队的最新研究成果
FieryGS: In-the-Wild Fire Synthesis with Physics-Integrated Gaussian Splatting
被人工智能顶会 ICLR 2026 接收。
...
系统首先利用 3D 分割技术将场景中的高斯基元解耦为独立的物体实例，随后通
过最佳视角选择算法，
将物体在该视角下的渲染图输入给大模型
。
...
RainyGS 以高斯表面表达为核心，将降雨、积水、涟漪等复杂流体现象直接绑定于高斯的几何描述之上，实现了从「静态重建」到「动态物理」的关键跨越，是 Real2Sim2Real 路径上的重要一步
（项目主页：https://pku-vcl-geometry.github.io/RainyGS/）
。
