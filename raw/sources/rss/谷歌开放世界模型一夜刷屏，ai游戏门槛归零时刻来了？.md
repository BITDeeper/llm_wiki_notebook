...
谷歌世界模型，再一次惊艳了所有人！
今天一早，
谷歌 DeepMind 开放了世界模型 Genie 3 的实验性研究原型「Project Genie」，允许用户创建、编辑并探索虚拟世界
。
在世界模型 Genie 3 之外，Project Genie 同样由图像生成与编辑模型 Nano Banana Pro 和语言模型 Gemini 提供技术支撑。
去年 8 月，谷歌预发布了通用世界模型
Genie 3
，它能够生成多样化的交互式环境。在这一早期阶段，受邀测试者们已经创造出了令人印象深刻且极具吸引力的虚拟世界与沉浸式体验，并挖掘出了全新的使用方式。
接下来的目标是构建一个专注于「沉浸式世界创建」的交互式原型，进一步扩大受众范围。
因此自即日起，谷歌面向
美国 18 岁及以上的 Google AI Ultra 用户
开放了 Project Genie 的访问权限。
