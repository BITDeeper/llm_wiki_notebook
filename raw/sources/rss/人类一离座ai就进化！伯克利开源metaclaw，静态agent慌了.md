...
开源即登顶。
MetaClaw刚刚发布便霸榜HuggingFace，它所代表的
「Agent持续进化」
理念，已经引起了全球AI研究者和开发者的高度关注。
...
但现实世界却是在不断变化的：
任务需求在漂移，工作流程在修改，工具链与组织规则也在不断更新
。
...
测试数据揭示了一个更关键的现象：
MetaClaw首先是一个Agent持续进化框架，而且对弱底模驱动的Agent增益尤其明显
。
