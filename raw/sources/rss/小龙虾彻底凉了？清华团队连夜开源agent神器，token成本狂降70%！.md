...
· 专属文件系统：
哪些文件归这个项目、AI生成了什么，边界清楚。
· 专属记忆：
Project Memory记项目定义和进度，Collaboration Feedback记你的偏好。全都看得见、改得了、追得到来源。
· 专属技能：
Skill应用商店一键装到对应WorkSpace，给做游戏的舱装game-asset-finder，给写文档的舱装minimax-pdf。
