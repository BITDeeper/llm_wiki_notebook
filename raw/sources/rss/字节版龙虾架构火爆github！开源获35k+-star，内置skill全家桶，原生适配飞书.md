...
1.0版本采用固定5节点多智能体架构，能力边界相对明确，主要聚焦在
深度研究
场景。
...
在框架层面，DeerFlow 2.0已经整合
子智能体调度、长期记忆、隔离沙箱执行环境、可扩展技能与工具等关键模块
，形成了一套完整、成熟的智能体运行能力体系。
可插拔Skill体系
...
同时系统提供MCP与Python接口，支持自定义工具的深度集成，甚至
可接入Claude Code
，让用户在终端就能完成工具的下发、查看与管理操作
隔离沙箱执行环境
...
本地部署需要满足一定的前置条件，包括
Python 3.12+、Node.js 22+、pnpm、uv包管理器以及nginx
。
