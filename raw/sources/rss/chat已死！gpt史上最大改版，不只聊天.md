...
估值只是最表层的压力。
收入端
，Anthropic的年化营收已经超过OpenAI。
从不到10亿到超过300亿，只花了一年出头。有分析师口径更激进，称5月底ARR已接近470亿。
用户端
，ChatGPT的10亿MAU增速只有62%。Claude App的月活只有5600万，体量还不到ChatGPT的零头，但增速是640%。
不仅如此，美国用户装了Claude App之后，直接让ChatGPT的使用时间平均少了5%。
编程工具
战场上，Claude Code拿下了54%的市占率，GitHub星标112K，Codex CLI只有74K。Claude Code已经占到公共GitHub commit的10%左右，年初这个数字才4%。
