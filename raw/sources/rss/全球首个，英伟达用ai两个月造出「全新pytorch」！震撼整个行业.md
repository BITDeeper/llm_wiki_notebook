...
最近，英伟达又发布了一个炸裂成果。
英伟达高级工程师Bing Xu开源了VibeTensor项目，并且表示：
「
这是第一个完全由
AI
智能体生成的
...
AI
生成算子内核套件
的宏观结构示意图，该套件包含多个后端实现（Triton、CuTeDSL以及PyTorch参考路径）
...
参考资料：
https://x.com/mark_k/status/2020794242562486361
