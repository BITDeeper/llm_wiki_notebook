...
在智能体编码任务上，78.4%
的Terminal-Bench和87.4%的SWE-bench证明，Mythos效果出众。
这是愚人节玩笑，还是泄露的真实数据？
...
不同于大家猜测的Mythos（目前尚无实据），代码中明确指向了名为
capybara-v2-fast
的新模型。
...
有趣的是，
ant/internal
用户（Anthropic员工）是第一波「金丝雀」，只有在内部验证通过后，才会向外部用户解锁。
泄露代码中显示，
Anthropic竟在代码里下毒
...
虽然官方尚未公布正式的SKU命名或发布日期，但从代码的成熟度来看，
Capybara家族已经箭在弦上。
