...
编辑：倾倾
【新智元导读】
OpenAI根本没有护城河！顶级分析师Benedict Evans判断：大模型本质上是「大宗商品」，OpenAI极有可能重演Netscape的悲剧。80%的用户一年交互不足千次、Meta掏出50%的收入去买芯片，AI行业的「财务重力」时刻已经到来。
...
通过对Reddit上数千名用户分享的年度总结数据进行抓取，Evans发现了一个惊人的规律：
绝大多数用户平均每天与AI的交互次数不足3次!
...
软件的「即兴」革命：SAP会被取代吗？
在谈到 AI 对软件行业的冲击时，Evans 提出了一个新的分类法：
即兴软件vs 制度化软件。
