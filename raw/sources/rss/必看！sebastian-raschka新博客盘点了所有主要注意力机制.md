...
---
机器之心编译
前些天，著名 AI 技术作家 Sebastian Raschka 发布了一份「LLM 架构画廊」，获得了 AI 社区的高度关注和赞扬，参阅《
...
现在，时间才刚过去一周多，Raschka 又放出了另一篇重磅博客《
现代 LLM 中注意力变体的可视化指南
...
我特别期待 (1) 看到全新的
Mamba-3
层被集成到上述混合架构中（替换 Gated DeltaNet ），以及 (2)
注意
力残差
(attention residuals)
被广泛使用。
...
无论如何，我很好奇
DeepSeek V4
会带来什么，因为在过去的 2 年里，DeepSeek 一直是非常可靠的趋势引领者。
© THE END
转载请联系本公众号获得授权
