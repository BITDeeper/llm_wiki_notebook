...
Inferact 表示，其首要任务是继续支持 vLLM 作为独立的开源项目，并将改进成果分享给社区。
他们计划进一步提升 vLLM 的性能，深化对新兴模型架构的支持，并扩大对前沿硬件的覆盖范围。
Inferact 的
第二个目标是开发一款独立的商业产品，帮助企业在不同类型的硬件上更高效地运行 AI 模型。
值得关注的是，vLLM 项目的核心贡献者清华博士
游凯超
成为了这家公司的联合创始人。
据介绍，Inferact 的创始团队包括 Simon Mo、Woosuk Kwon、Kaichao You（
游凯超
）、Roger Wang、Joseph Gonzalez、Ion Stoica 等人。
参考链接：
https://inferact.ai/
