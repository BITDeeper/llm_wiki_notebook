...
编辑：好困
【新智元导读】
一个毫无代码的文本，竟连霸GitHub热榜第一。Karpathy的
编程神技
被化作「AI紧箍咒」，让乱写Bug的大模型瞬间老实！
...
产物就是这个CLAUDE.md，相当于是在Agent脑子里装的一套行为准则。（现在也有了
Cursor版）
...
为什么一个.md文件能炸成这样
在
Karpathy看来，LLM编程带来的不只是加速，更是一种扩展，你能做到以前不值得做的事，能碰以前碰不了的代码。
