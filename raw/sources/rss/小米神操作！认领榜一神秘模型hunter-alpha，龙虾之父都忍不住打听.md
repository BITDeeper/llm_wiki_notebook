...
克雷西 发自 凹非寺
量子位 | 公众号 QbitAI
占领OpenRouter调用量榜单第一的神秘模型
Hunter Alpha
，终于揭开神秘面纱——
既不是GPT，也不是DeepSeek，而是来自小米的万亿旗舰模型
MiMo-V2-Pro
。
...
根据Artificial Analysis的最新评测，它成功拿下了
国产第二、全球第八
和的优异排名。
...
MiMo-V2-Omni作为全模态模型，最大的亮点在于它
把图像、视频和音频编码器融合进了一个主干网络里
。
...
就连龙虾之父Peter Steinberger也在X上发帖询问
，有没有人知道这两款模型的具体细节。
