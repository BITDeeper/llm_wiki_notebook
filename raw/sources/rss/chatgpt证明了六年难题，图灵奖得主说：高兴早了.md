...
Sutton自己的回答是：
不能被取代，但角色要彻底转型。
他在演讲中说，哪怕是能独立证明数学定理的AI，目前仍然需要人类来告诉它：
哪些问题是重要的。
这不是谦虚，而是真实的认知边界。
数学家Shiqian Ma，莱斯大学（Rice University）优化领域学者，说：他用ChatGPT，
证明了一个让他研究了整整六年的算法收敛性问题。
摘要里有一句话：
...
他总结得极其清醒：
研究的本质没变，还是反复试错。变的是每一次试错的速度
——过去需要几周验证一个方向，现在几分钟就能知道这条路走不走得通。
但AI的贡献不可磨灭：
然后，结尾直接封神：
