...
编辑：Aeneas
【新智元导读】
GPT-5.4，马上就要来了！目前已经开启测试，一次能写6000行代码。外媒曝出它有极限推理模型，甚至还传闻拥有永久记忆。
...
接下来，更戏剧性的一幕出现：OpenAI Codex团队的一名员工
Tibo
在社交平台上发布了一张截图。图中，
模型选择器里赫然写着GPT-5.4
。
...
一些测试者表示，模型的推理明显更快，代码生成更长，甚至一次提示可生成
6000+行代码！
这在以前几乎不可能。
...
Jeff Dean在参加
latentspacepod
播客时就提到了这一点，可以看出，如今各大AI实验室都在思考这个方向。
