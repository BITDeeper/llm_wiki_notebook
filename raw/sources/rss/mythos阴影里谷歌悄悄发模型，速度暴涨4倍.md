...
在同一块H100上
（fp8，batch size=1）
，DiffusionGemma跑出了1000+ tokens/s，而采用标准自回归的Gemma 4 26B A4B加上MTP加速也只有300+ tokens/s——
速度拉开近4倍
。
...
双向注意力：不止是快
速度之外，DiffusionGemma身上还有一个点值得关注：
双向注意力
。
...
谷歌也很坦诚，
生产环境推荐标准Gemma 4，DiffusionGemma面向的是速度敏感的本地交互场景
。
