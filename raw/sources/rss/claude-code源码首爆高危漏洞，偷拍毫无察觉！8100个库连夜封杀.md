...
编辑：编辑部
【新智元导读】
51万行代码全球裸奔，Anthropic差点没绷住！一夜封杀8100个GitHub库，竟有8000个是「误伤」。更劲爆的是，CC克隆库还有高危漏洞。
...
8100个开源代码库，一口气全部封杀。
然而，
真正泄密的，只有1个原仓库，以及96个Frok！剩下的全是「误杀」！
一时间，全网炸开了锅。
这种「宁可错杀一千，绝不放过一个」的操作，令全网震怒。
Claude Code之父Boris Cherny紧急救火，他表示，「这不是有意为之，正GitHub一起修复问题」。
除此以外，随着Claude Code源码泄漏，黑客白客都在加班加点进行安全审查，
一些严重安全漏洞也浮出水面
：
仅仅输入一行「claude」，你的电脑就可能不知不觉变成了黑客的「肉鸡」，
随意调用你的摄像头拍照、窃取你的密钥！
8100个库连夜下架，几乎惨遭误杀
