...
编辑：Aeneas
【新智元导读】
他没博士、没论文，却靠公开改进论文和跑基准测试，直接打动大佬、入职OpenAI！Noam Brown亲证：行动力和开源项目，才是逆袭顶级AI实验室的真正通行证。
...
Andy Jones是一位半退休的量化分析师，在测试时计算还没火起来之前，他就写了一篇论文，毕竟了比较了
扩大预训练规模
和扩大测试时计算量的影响。
这篇论文让人印象极其深刻，并是因为刷新了某个基准，而是做出了非常聪明的设计选择，自己编写了
GPU
加速的环境
，并且进行了
严谨细致的消融实验。
