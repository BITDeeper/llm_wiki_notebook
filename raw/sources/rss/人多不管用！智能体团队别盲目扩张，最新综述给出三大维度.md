...
图1 2025年智能体市场与智能体系统增长趋势。
市场中的智能体数量采用对数坐标显示，市场类别数和每个系统中的智能体数采用单独坐标轴显示，阴影区域表示估计范围。
数据来源：
Internet Archive（Wayback Machine）存档网页快照，包括OpenAI GPTs、AWS Marketplace和Agent.ai。
